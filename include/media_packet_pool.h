 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_OUT_OF_MEMORY Out of memory
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION The user set the invalid format with media_packet_pool_set_format() or set the invalid size with media_packet_pool_set_size().\n
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION The user does not allocate the pool.\n
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_OUT_OF_MEMORY Out of memory
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION The user releases media packet which is not associated with a given pool.
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION The user does not release all media packets to the pool.
 *
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION The user does not create media packet pool instance, or not deallocate all media packets with media_packet_pool_deallocate().
 *
