 ...
 *          If the pool is empty, it will be increased to #max_buffers of given parameter.
 *
 * @since_tizen 3.0
 *
 ...
 * @param[out]	curr_buffers	The current number of buffers
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @details It will allocate media packets with the configured parameters.
 *
 * @since_tizen 3.0
 *
 * @param[in]	pool	The allocated pool handle
 ...
 * @param[in]   timeout It indicates the millisecond-timeouts to block while waiting for media packet is released.
