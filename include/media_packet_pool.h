...
typedef enum {
	...
	MEDIA_PACKET_POOL_ERROR_NO_AVAILABLE_PACKET = TIZEN_ERROR_MEDIA_TOOL | 0x01,    /**< No Available packet */
 ...
 * @post After the pool has been configured, it can be activated with media_packet_pool_allocate().
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_OUT_OF_MEMORY Out of memory
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION When the pool has been already activated
 *
 ...
 * @post The pool will be activated. When the pool is activated, media_packet_pool_acquire_packet() can be used to retrieve a packet from the pool.
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION When the pool has not been configured or has not been activated
 * @retval #MEDIA_PACKET_POOL_ERROR_NO_AVAILABLE_PACKET No available packet
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_OUT_OF_MEMORY Out of memory
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION When the media packet which is not being created on the pool is released
 ...
 * @retval #MEDIA_PACKET_POOL_ERROR_NONE Successful
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIA_PACKET_POOL_ERROR_INVALID_OPERATION When all media packets are not returned to the pool
 *
 * @pre media packet should be released before calling media_packet_pool_deallocate().
 * @post The pool will be deactivated. media_packet_pool_acquire_packet() calls will return an error.
